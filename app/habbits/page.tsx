...
export default function Page() {
  ...
  const habbitList = [
    ...
    { name: "Admissions", minimum: "Turkey Universities", points: 5 },
    { name: "Electronics", minimum: "  diode and next video record ", points: 40 },
    { name: "AI", minimum: " AI mate chatting feathure final and LLM ", points: 40},
    { name: "A Level Math", minimum: "Differentiation Equation past papers  ", points: 25 },
  ];
