...
export default function Page() {
  ...
  const habbitList = [
    ...
    { name: "Admissions", minimum: "Italy resarch and usa and turkey", points:20  },
    // { name: "BNA", minimum: "Practice on 1 compitition and leetcode 2 questions and team and physics  ", points:15  },
    { name: "Electronics", minimum: "Short video and self balancing robot" , points:20  },
    { name: "AI", minimum: "CS50 C practice and Deeplearning computer practice", points:20  },
  { name:"A Level",minimun:" Trignometry,Poly,Partial fraction practice",points:25}
  ];
